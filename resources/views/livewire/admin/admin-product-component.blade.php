    ...
    <div class="container" style="padding:30px 0;">
        ...
        <div class="col-md-12">
            ...
            <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <a href="{{ route('admin.addproduct') }}" class="btn btn-danger pull-right">Add New Product</a>   
                </div>
                </div>
                </div>
				...
				?>
                            <tr>
                                <td>{{ $product->id }}</td>
                                <td><img src="<?= check_image_exists($test_orig_image, $my_deafult_image); ?>" width="60" alt="{{ $product->name }}" /></td>
                                <td>{{ $product->name }}</td>
