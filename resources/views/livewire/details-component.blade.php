<div>
    ...
    <main id="main" class="main-site">
        ...
        <div class="container">
            ...
            <div class="row">
            <?php
				$test_orig_image = "{{asset('assets')}}/images/products/{{ $product->name }}/{{ $product->image }}";
				$my_deafult_image = $my_deafult_image = "../assets/images/products/$product->image";
				?>
                    ...
                    <div class="wrap-product-detail">
                        <div class="detail-media">
                            <div class="product-gallery" wire:ignore>
                                <ul class="slides">
                                    ...
                                    <li data-thumb="<?php echo check_image_exists($test_orig_image, $my_deafult_image); ?>">
                                        <img src="<?php echo check_image_exists($test_orig_image, $my_deafult_image); ?>" width="800" height="800" alt="{{ $product->name }}" />	
                                    </li>
                                    @php
                        ...
                        <div class="detail-info">
                            <div class="product-rating">
                                ...
                                @endphp
                                @endforeach
                                @for($i=1;$i<=5;$i++) @if($i<=$avgration) <i class="fa fa-star" aria-hidden="true"></i>
                                    @else
                            ...
                            <div class="wrap-price">
                                ...
                                <del><span class="product-price regprise">${{ $product->regular_price }}</span></del>
                            </div>
                            @else
                            ...
                            <div class="col-xs-10">
                                ...
                                <option value="">-- {{$av->productAttribute->name}} --</option>
