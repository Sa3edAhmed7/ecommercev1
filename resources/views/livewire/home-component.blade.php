					...
					<div class="product product-style-2 equal-elem ">
						<div class="product-thumnail">
							<a href="{{ route('product.details',['slug'=>$sproduct->slug]) }}" title="{{ $sproduct->name }}">
								<figure><img src="{{asset('assets')}}/images/products/{{ $sproduct->name }}/{{ $sproduct->image }}" width="800" height="800" alt="{{ $sproduct->name }}"></figure>
							</a>
									...
									<div class="product product-style-2 equal-elem ">
										<div class="product-thumnail">
											<a href="{{ route('product.details',['slug'=>$lproduct->slug]) }}" title="{{ $lproduct->name }}">
												<figure><img src="<?php echo check_image_exists($test_orig_image, $my_deafult_image); ?>" width="800" height="800" alt="{{ $lproduct->name }}" /></figure>	
											</a>
											<div class="group-flash">
									...
									<div class="product product-style-2 equal-elem ">
										<div class="product-thumnail">
											<a href="{{ route('product.details',['slug'=>$c_product->slug]) }}" title="{{ $c_product->name }}">
												<figure><img src="<?php echo check_image_exists($test_orig_image, $my_deafult_image); ?>" width="800" height="800" alt="{{ $c_product->name }}" /></figure>	
											</a>
											<div class="group-flash">
												<span class="flash-item new-label">new</span>
											</div>
