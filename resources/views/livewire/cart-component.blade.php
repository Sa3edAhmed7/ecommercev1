    ...
    <div class=" main-content-area">
                ...
                @foreach (Cart::instance('cart')->content() as $item)
                   <li class="pr-cart-item">
                    <div class="product-image">
                        <figure><a href="{{ route('product.details',['slug'=>$item->model->slug]) }}"><img src="{{asset('assets')}}/images/products/{{ $item->model->image }}" alt=""></a></figure>
                    </div>
                    ...
                    <div class="price-field sub-total">  
                        <p class="text-center"><a href="" wire:click.prevent="switchToSaveForLater('{{ $item->rowId }}')"><i class="fa fa-pause-circle" style="font-size:30px;color:red"></i></a></p>
                    </div>
                    <div class="delete">
                        <a href="#" wire:click.prevent="destroy('{{$item->rowId}}')" title="">
                            <i class="fa fa-times-circle" style="font-size:30px;color:red" aria-hidden="true"></i>
                        </a>
                    </div>
                </li>
            @endforeach											
        ...
        <div class="summary">
            <div class="order-summary">
                ...
                <span class="summary-info"><span class="title">Discount ({{ Session::get('coupon')['code'] }})</span><a href="#" wire:click.prevent="removeCoupon"><i class="fa fa-times text-danger">${{number_format($discount,2)}}</i></a></span>
        ...
        @if(Session::has('success_message'))
            ...
            <ul class="products-cart">
                ...
                <li class="pr-cart-item">
                    ...
                    <div class="price-field produtc-price"><p class="price">${{ $item->model->regular_price }}</p></div>
                    <div class="quantity">
                            <p class="text-center"><a href="" wire:click.prevent="moveToCart('{{ $item->rowId }}')"><i class="fa fa-shopping-cart" style="font-size:33px;color:red"></i></a></p>
                    </div>
                    <div class="delete">
                        <a href="#" wire:click.prevent="deleteToSaveForLater('{{$item->rowId}}')" title="">
                            <i class="fa fa-times-circle" style="font-size:30px;color:red" aria-hidden="true"></i>
                        </a>
                    </div>
                </li>
