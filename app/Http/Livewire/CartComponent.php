...
class CartComponent extends Component
{
    ...
    public function destroy($rowId) {
     ...
     public function deleteToSaveForLater($rowId)
     {
        Cart::instance('saveForLater')->remove($rowId);
     ...
     {
        $coupon = Coupon::where('code',$this->couponCode)->where('expiry_date','>=',Carbon::now())->where('cart_value','<=',Cart::instance('cart')->subtotal())->first();
        if(!$coupon)
        {
